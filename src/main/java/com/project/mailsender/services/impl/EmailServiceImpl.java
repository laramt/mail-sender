...
public class EmailServiceImpl implements EmailService {
    ...
    private static final String EMAIL_WITHATTACHMENT_TEMPLATE = "html/email-email.html";
    ...
    public EmailServiceImpl(EmailRepository repository, JavaMailSender emailSender, TemplateEngine htmlTemplateEngine, EmailMapper mapper) {
